...
export default function Onboarding({
  ...
  // Keep html/body background-color in sync as a fallback.
  useLayoutEffect(() => {
  ...
  return (
    <>
      {/*
        Background layer: extends past bottom:0 into the home-indicator zone.
        On iOS PWA, position:fixed bottom:0 lands at the visual-viewport edge,
        above the home indicator. Using calc(-1 * env(safe-area-inset-bottom))
        pushes the element's bottom edge to the physical screen bottom so the
        gradient actually paints behind the home indicator.
      */}
      <div
        style={{
          position: "fixed",
      ...
      {/* Content layer: transparent, respects safe areas */}
      <div
        style={{
          position: "fixed",
          inset: 0,
